...
window.onload = function () {
    ...
    for(var x = 0; x < MAP_WIDTH; x++) {
        ...
        for(var y = 0; y < MAP_HEIGHT; y++) {
            tiles[x].push({ground: (Math.random() > 0.15 ? GROUND_TYPES.grass : GROUND_TYPES.stone), building: (Math.random() > 0.95 ? BUILDING_TYPES.pylon : GROUND_TYPES.empty), stateData: {}});
        }
    }
